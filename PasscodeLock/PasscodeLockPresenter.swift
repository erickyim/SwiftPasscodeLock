...
open class PasscodeLockPresenter {
    ...
    public init(mainWindow window: UIWindow?, configuration: PasscodeLockConfigurationType, viewController: PasscodeLockViewController) {
        ...
        mainWindow = window
        mainWindow?.windowLevel = UIWindow.Level(1)
    ...
    open func presentPasscodeLock() {
        ...
        passcodeLockWindow.windowLevel = UIWindow.Level(2)
        ...
        if animated {
            UIView.animate(
                ...
                completion: { [weak self] _ in
                    ...
                    self?.passcodeLockWindow.windowLevel = UIWindow.Level(0)
            ...
            passcodeLockWindow.windowLevel = UIWindow.Level(0)
